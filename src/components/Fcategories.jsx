...
const ResponsiveGridLayout = () => {
  ...
  const redirectToBookBoxesPage = () => {
    window.location.href = "/shop/book-boxes";
  };

  
  const redirectToPage = (pageName) => {
    window.location.href = `/shop/${pageName}`;
  };
  return (
    ...
    >
      <div className="h-auto flex hov flex-col justify-center items-center">
        ...
        <div className="text-center text-3xl popinsfont pt-3">BOOK BOX</div>
      </div>
    </div>
    ...
    <div
        className="h-auto flex hov flex-col justify-center align-middle"
        onClick={() => redirectToPage("booksleeves")}
        style={{ cursor: "pointer" }}
      >
        <div className="imgcont">
          <Image
      ...
      <div
        className="h-auto flex hov flex-col justify-center align-middle"
        onClick={() => redirectToPage("bookmarks")}
        style={{ cursor: "pointer" }}
      >
        <div className="imgcont">
          <Image
      ...
      <div
        className="h-auto flex hov flex-col justify-center align-middle"
        onClick={() => redirectToPage("hardcover")}
        style={{ cursor: "pointer" }}
      >
        <div className="imgcont">
          <Image
      ...
      <div
        className="h-auto flex hov flex-col justify-center align-middle"
        onClick={() => redirectToPage("premium")}
        style={{ cursor: "pointer" }}
      >
        <div className="imgcont">
          <Image
